...
ECOMMERCE_DOCUMENTS = [
    ...
    {
        "content": (
            "X1智能手机是星耀品牌2026年旗舰产品，搭载骁龙8 Gen4处理器，6.8英寸AMOLED屏幕，"
            "120Hz刷新率，5000mAh电池，支持65W有线快充和30W无线快充。后置三摄：5000万主摄+"
            "4800万超广角+1200万长焦。存储规格：12GB+256GB（标准版）、16GB+512GB（高配版）、"
            "16GB+1TB（尊享版）。起售价3999元。适用于游戏、摄影、日常使用。"
        ),
        "source": "products/smartphone_x1.md",
    },
    {
        "content": (
            "星耀X1的官方配件包括：65W氮化镓充电器（型号GN65W，售价129元）、30W无线充电板（型号WC30，"
            "售价199元）、磁吸保护壳（四色可选，售价79元）、钢化膜套装（售价39元）、蓝牙降噪耳机"
            "（型号Buds Pro 3，售价499元，支持LDAC和主动降噪）。所有配件均享受7天无理由退换。"
        ),
        "source": "products/smartphone_x1_accessories.md",
    },
    {
        "content": (
            "星耀Pad Air平板电脑，11英寸2.5K LCD屏幕，90Hz刷新率。搭载天玑9300处理器，"
            "8GB+256GB存储，8000mAh电池，支持33W快充。四扬声器杜比全景声。售价2499元起。"
            "与X1手机无缝互联，支持跨设备剪贴板、文件拖拽传输和应用流转。可搭配星耀智能触控笔"
            "（售价349元）和磁吸键盘（售价599元）使用。"
        ),
        "source": "products/tablet_pad_air.md",
    },
    {
        "content": (
            "星耀Watch GT智能手表：1.5英寸OLED圆形表盘，支持心率/血氧/睡眠/压力监测，"
            "IP68防水，14天续航，支持NFC支付和eSIM独立通话。售价1299元。"
            "兼容X1手机实现消息通知同步、音乐控制、远程拍照。含运动模式100+种。"
            "表带可更换：氟橡胶运动表带（标配）、真皮表带（199元）、不锈钢表带（299元）。"
        ),
        "source": "products/watch_gt.md",
    },
    {
        "content": (
            "星耀Buds Pro 3真无线降噪耳机：支持LDAC高清音频，自适应主动降噪（-42dB），"
            "空间音频头部追踪，IPX5防水。耳机续航8小时，充电盒额外32小时，支持无线充电。"
            "售价499元。兼容X1手机的一键弹窗配对和查找耳机功能。与Watch GT配合可在手表上"
            "直接控制音乐播放和降噪模式切换。"
        ),
        "source": "products/buds_pro3.md",
    },
    {
        "content": (
            "热门产品对比：X1手机（3999元起，旗舰性能）vs Pad Air（2499元起，娱乐办公）。"
            "二者搭配使用体验最佳：手机上复制的文字自动同步到平板，平板上的文档可直接拖到手机。"
            "如果预算有限，可先入手X1标准版，后续再添购Pad Air作为办公补充。"
            "X1的竞品包括：某为Mate 70（4299元起）、某米15 Pro（3699元起）。"
            "X1在影像系统和系统流畅度上领先竞品，但在品牌认知度上仍有提升空间。"
        ),
        "source": "products/comparison.md",
    },
    # 电商政策
    {
        "content": (
            "退换货政策：自签收之日起7天内可申请无理由退换货（需商品完好、配件齐全、包装完整）。"
            "15天内出现非人为质量问题可免费换新。1年整机保修（非人为损坏）。"
            "以下情况不支持7天无理由：已激活的软件产品、已拆封的个人护理产品、定制商品。"
            "退款流程：提交申请→客服审核（1-2工作日）→寄回商品→仓库验收（1-2工作日）→"
            "财务退款（3-5工作日原路返回）。用户可在订单详情页查看退换货进度。"
            "配件类商品（如充电器、耳机、保护壳）同样适用7天无理由，但需不影响二次销售。"
        ),
        "source": "policies/return_policy.md",
    },
    {
        "content": (
            "物流配送政策：全国包邮（港澳台及偏远地区除外）。默认发顺丰快递，"
            "当日16:00前下单当日出库。配送时效：一线城市1-2天，二三线城市2-4天，"
            "县城及乡镇3-6天。支持加急配送（+19.9元，当日达/次日达，仅限一线城市）。"
            "物流查询：在订单详情页点击'查看物流'获取实时轨迹。签收时请当面验货，"
            "如有破损请拒收并联系客服，我们将安排补发。"
        ),
        "source": "policies/shipping_policy.md",
    },
    {
        "content": (
            "售后服务：全国200+城市设有官方授权维修点。X1手机享受首年一次免费贴膜服务。"
            "碎屏保（199元/年）：意外碎屏免费更换原装屏幕一次。延保服务（299元/年）："
            "在1年标准保修基础上延长1年。以旧换新：旧手机折价回收，最高可抵3000元。"
            "客服热线：400-888-XXXX（7×24小时）。在线客服：App内'我的-客服'入口。"
            "企业团购（10台以上）可享受专属优惠和专属客户经理服务。"
        ),
        "source": "policies/after_sales.md",
    },
    # 订单与支付
    {
        "content": (
            "下单流程：选择商品→加入购物车→确认订单（选择规格/数量/优惠券）→"
            "填写收货地址→选择支付方式→提交订单→支付→等待发货。"
            "支持支付方式：微信支付、支付宝、银行卡、白条分期（3/6/12期，费率0.6%/期）。"
            "新用户首单享9折优惠（最高减100元）。学生认证享专属教育优惠。"
            "订单取消：未发货订单可随时取消，款项即时退回。已发货订单需先拒收再申请退款。"
            "订单修改：仅未发货订单可修改收货地址和联系电话。"
        ),
        "source": "policies/order_flow.md",
    },
    {
        "content": (
            "优惠券使用规则：店铺券（满减券、折扣券）在结算时自动抵扣，每单限用1张。"
            "平台券可与店铺券叠加使用。优惠券有效期以券面显示为准，过期自动失效。"
            "退货时优惠券不退不补。积分兑换：100积分=1元，积分有效期1年滚动清零。"
            "会员等级：普通会员（累计消费0-2000元，98折）→银卡会员（2000-5000元，95折+"
            "生日礼包）→金卡会员（5000-20000元，92折+优先发货+专属客服）→"
            "钻石会员（20000元以上，88折+所有权益）。"
        ),
        "source": "policies/promotions.md",
    },
]
